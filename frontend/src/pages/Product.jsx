      ...
      <div className="mt-20">
			  <div className="flex">
				...
				<div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
					<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic sunt inventore, obcaecati nostrum veritatis deleniti officiis soluta voluptatum perspiciatis explicabo repellendus eaque dolore excepturi illum quidem provident nulla esse fugit?</p>
					<p>obcaecati nostrum veritatis deleniti officiis soluta voluptatum perspiciatis explicabo repellendus eaque dolore excepturi illum quidem provident nulla esse fugit?</p>
				</div>
      </div>
